...
(function()
{
	...
	foreach (array("PID_SETUP_ACTION_NAME", "PID_SETUP_INDEX_FILES", "PID_INDEX_CONTENT_FILENAME", "PID_DEFAULT_INDEX_CONTENT", "PID_CLASS_REGISTER_FILENAME") as $constantName)
	{
